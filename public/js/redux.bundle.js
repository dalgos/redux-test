...
var Counter = function () {
  function Counter(root) {
    ...
    this.render = function () {
      console.log(_this);
      _this.displaySpan.innerHTML = _this.store.getState().toString();
    };
...
var Counter = __webpack_require__(7);

var counter = new Counter(document.body);
